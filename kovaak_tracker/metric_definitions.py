...
METRIC_DEFINITIONS: dict[str, dict[str, str]] = {
    ...
    "static_clicking.reverse_ratio": {"name": "反向移动比例", "description": "移动路径中反向速度分量所占的比例"},
    ...
    "reverse_ratio": {"name": "反向移动比例", "description": "移动路径中反向速度分量所占的比例"},
    ...
    "endpoint_peak": {"name": "末端速度峰值标记", "description": "速度峰值是否位于移动末端的标记"},
    ...
    "target_switching.transition_time_ms": {"name": "切换移动时长", "description": "从离开上一目标到捕获下一目标的时长"},
    ...
    "target_switching.settle_duration_ms": {"name": "捕获后稳定时长", "description": "从捕获下一目标到该切换链稳定时刻的时长"},
    ...
    "dynamic_clicking.acquisition_time_ms": {"name": "捕获时长", "description": "从记录的捕获开始时刻到点击时刻的时长"},
