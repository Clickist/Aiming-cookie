...
> **Status:** completed. Task 1-3 与实机 normal/timescale/Restart 证据已进入当前实现；Complete Coach 对 source precision、presence 与 frozen window 的新增 correctness 要求由新的 active plan Task 1 承接。
