...
> **Status:** completed at the internal and NVIDIA product-path evidence boundary. Tasks 1-9、normal Challenge、interrupted-finalization 与 Storage rows 已闭合；AMD/Intel 物理硬件保留为 Roadmap 外部发布 Gate，不得继续扩大本计划。
...
- [`../../../superpowers/specs/2026-07-17-automatic-run-capture-design.md`](../../../superpowers/specs/2026-07-17-automatic-run-capture-design.md)
- [`../../../superpowers/specs/2026-07-13-kovaak-run-trace-lifecycle-design.md`](../../../superpowers/specs/2026-07-13-kovaak-run-trace-lifecycle-design.md)
