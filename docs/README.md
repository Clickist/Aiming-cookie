...
- 自动 Run finalization 当前施工：使用 active [`superpowers/plans/2026-07-19-automatic-run-finalization-v1.md`](superpowers/plans/2026-07-19-automatic-run-finalization-v1.md)，按 Task 的 Allowed files、Tests first 与 Stop rule 执行。
